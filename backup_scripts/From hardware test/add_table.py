...
def add_flat_table_and_rectangle():
    ...
    table_primitive.dimensions = [1.0, 1.0, 0.02]  # [x, y, z] in meters
    ...
    table_pose.pose.position.z = 0.01  # **Change Table Z Position Here/origanl was -0.025**
    ...
    rectangle_primitive.dimensions = [0.04, 0.035, 0.105]  # [x, y, z] in meters
    ...
    rectangle_pose.pose.position.x = 0.44  # 48**Change Rectangle X Position Here** previous setting was 0.48
    rectangle_pose.pose.position.y = 0.17  #17 **Change Rectangle Y Position Here**previous setting was 0.17
    rectangle_pose.pose.position.z = -0.025 + 0.05 + 0.005 + 0.04  # On top of the table
